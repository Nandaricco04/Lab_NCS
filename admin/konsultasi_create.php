...
$err = '';
$nama_konsultasi = $nim_konsultasi = $isi_konsultasi = $tanggal_konsultasi = $email_konsultasi = $no_wa_konsultasi = '';
$status = 'Proses';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($nama_konsultasi === '' || $nim_konsultasi === '' || $isi_konsultasi === '' || $tanggal_konsultasi === '' || $email_konsultasi === '' || $no_wa_konsultasi === '' || $status === '') {
        ...
        try {
            qparams(
                'INSERT INTO "konsultasi" ("nama_konsultasi", "nim_konsultasi", "isi_konsultasi", "tanggal_konsultasi", "email_konsultasi", "no_wa_konsultasi", "status") VALUES ($1, $2, $3, $4, $5, $6, $7)',
                [$nama_konsultasi, $nim_konsultasi, $isi_konsultasi, $tanggal_konsultasi, $email_konsultasi, $no_wa_konsultasi, $status]
            );
                ...
                <div class="card-wrapper">
                    ...
                    <form class="form-user-box" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            <label for="nama_konsultasi" class="user-form-label">Nama<span style="color:red">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="nim_konsultasi" class="user-form-label">NIM<span style="color:red">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="isi_konsultasi" class="user-form-label">Isi Konsultasi<span style="color:red">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="tanggal_konsultasi" class="user-form-label">Tanggal Konsultasi<span style="color:red">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="email_konsultasi" class="user-form-label">Email<span style="color:red">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="no_wa_konsultasi" class="user-form-label">No. WA<span style="color:red">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="status" class="user-form-label">Status<span style="color:red">*</span></label>
