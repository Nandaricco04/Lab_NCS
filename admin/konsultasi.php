...
$res = q('SELECT "id_konsultasi", "nama_konsultasi", "nim_konsultasi", "isi_konsultasi", "tanggal_konsultasi", "email_konsultasi", "no_wa_konsultasi", "status" FROM "konsultasi" ORDER BY "id_konsultasi" ASC');
