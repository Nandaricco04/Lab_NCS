...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id_pengabdian === '' || $id_pengelola === '' || $prodi === '' || $judul === '' || $skema === '') {
        ...
        try {
            qparams(
                'INSERT INTO "detail_pengabdian" ("id_pengabdian", "id_pengelola", "prodi", "judul", "skema") VALUES ($1, $2, $3, $4, $5)',
                ...
                <div class="card-wrapper">
                    ...
                    <form class="form-user-box" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            <label for="id_pengabdian" class="user-form-label">Tahun & Judul Pengabdian<span style="color:red">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="id_pengelola" class="user-form-label">Ketua<span style="color:red">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="prodi" class="user-form-label">Prodi<span style="color:red">*</span></label>
